...
public class BeerServiceTest {
    ...
    // SEARCH
        // buscar nome -> ok (feito)
        // buscar nome -> not found (feito)
    ...
    // LIST SEARCH
        // pedir lista -> ok (feito)
        // pedir lista -> empty (feito)
    @Test
    void whenListBeerIsCalledThenReturnAListOfBeers() {
        ...
        //when
        when(beerRepository.findAll()).thenReturn(singletonList(expectedFoundBeer));
    ...
    void whenListBeerIsCalledThenReturnAnEmptyListOfBeers() {
        //when
        when(beerRepository.findAll()).thenReturn(EMPTY_LIST);
    ...
    //INCREMENT
        //increment com id valido-> ok
        //increment com id valido-> exceeded
    ...
    // DECREMENT
        // decrement com id valido -> ok
        // decrement com id valido -> stock empty
